...
public class UICaptureBlur : RawImage
{
    /// <summary>
    /// Desampling rate.
    /// </summary>
    ...
    public void SetQulityMode(int mode)
    {
        switch (mode)
        {
            case 1:
                blurIterations = 2;
                reductionRate = DesamplingRate.x2;
                desamplingRate = DesamplingRate.x2;
                break;
            case 2:
                blurIterations = 3;
            ...
            case 3:
                blurIterations = 5;
                reductionRate = DesamplingRate.x1;
                desamplingRate = DesamplingRate.None;
                break;
        }
    }
